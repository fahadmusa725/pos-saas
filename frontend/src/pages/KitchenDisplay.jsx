      ...
      <main className="flex-1 p-6 overflow-y-auto">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center h-80 text-gray-500 space-y-2">
            ...
            <p className="text-lg font-medium">All caught up! No pending kitchen items.</p>
            <p className="text-sm text-gray-600">New incoming items will pop up here in real time.</p>
          </div>
        ) : (
                  ...
                  <div className="p-4 flex-1 space-y-4 overflow-y-auto max-h-80">
                    {(() => {
                      ...
                      return Object.entries(itemsByRound).map(([roundNum, items]) => (
                        <div key={roundNum} className="space-y-2 border-b border-gray-700/60 pb-3 last:border-b-0 last:pb-0">
                          <div className="flex items-center justify-between">
                            <span className="text-[11px] font-extrabold uppercase tracking-wider px-2 py-0.5 rounded bg-gray-700 text-amber-300">
                          ...
                          <div className="space-y-2">
                            {items.map((item) => {
                              ...
                              return (
                                <div key={item._id} className="flex items-center justify-between gap-2 bg-gray-900/60 p-2.5 rounded-xl border border-gray-750">
                                  ...
                                  {/* Morphing Option A Action Button */}
                                  <button
                                    onClick={() =>
                                  ...
                                  >
                                    {isPreparing ? '✅ Ready for Waiter' : '👨‍🍳 Start Prep'}
                                  </button>
                                </div>
                              );
                            })}
